  ...
  return (
    <div>
      ...
      <div className="selection">
        <div className="selectionTitle">Entertainment</div>
        {destinationsArray.map((el, i) => {
          if (el.tags.includes(`entertainment`)) {
            return (
              <div
              ...
              >
                <div className="selectionElementTitle">
                  ...
                  <div className="selectionElementTitleStars">{ShowReviewStars(el.averageRating)}</div>
                </div>
                <img
                  src={el?.img}
                  alt={el.name}
